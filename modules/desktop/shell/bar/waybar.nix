...
in {
  ...
  config = mkIf (shell.bar == pkgs.waybar && builtins.elem device compDevices) {
    home-manager.users.${username} = {
      ...
      laptop = osConfig.core.device == "laptop";
      bluetooth = osConfig.core.bluetooth.enable;
      hyprland = inputs.hyprland.packages.${pkgs.system}.hyprland;
      hyprWaybar = inputs.hyprland.packages.${pkgs.system}.waybar-hyprland;
      package =
        if osConfig.desktop.wm == hyprland
        then hyprWaybar
        else pkgs.waybar;
      runner = osConfig.desktop.shell.runner;
      terminal = osConfig.desktop.shell.runner;
